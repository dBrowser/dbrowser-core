  ...
  if (typeof e === 'object') {
    ...
    switch (e.errorCode) {
      ...
      case 504:
        ...
        info = `
          <p class="big">Would you like DBrowserX- to watch for it to reappear?</p>
          <p><a href="dbrowser://watchlist/?url=${e.validatedURL}" class="btn big primary" target="_blank"><i class="fa fa-eye"></i> Add to watchlist</a></p>
        `
        errorDescription = `The p2p ${e.resource} was not found on the network.`
        button = `<a class="link right" href="dbrowser://swarm-debugger/${e.validatedURL}" target="_blank">Network debugger</a>`
        break
    }
  } else {
    errorDescription = e
